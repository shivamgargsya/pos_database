...
$response = array();
 if (isset($_POST['date']) && isset($_POST['waiter_name'])&& isset($_POST['reason'])&& isset($_POST['table_no']))
 {
	$date=$_POST['date'];
	...
	$result = mysql_query("SELECT *FROM return_orders WHERE date='$date' AND waiter_name='$waiter_name' AND reason='$reason' AND table_no='$table_no'") or die(mysql_error());
